...
class importexport {
    ...
    upload_datos(data) {
        return new Promise(function (resolve, reject) {
            ...
            function check() {//chekeamos que todos los datos del objeto se subieran
            ...
            for (const key in json_obj) {
                if (Object.hasOwnProperty.call(json_obj, key)) {
                    ...
                    if (element.id !== "") {
                        ...
                        element.ok = false;
                        console.log("subir");
                        my_genericos.httpPost(`${my_genericos.constantes.DBHOST}/cliente/create`, post, function (res) {
                            console.log(res);
                            element.ok = true;
                            if (check()) {
                                resolve("OK");
